...
class TemplateSendResidentController extends BuildingController
{
    ...
    public function index(Request $request)
    {
        ...
        $data['templates'] = $this->repository->getResidentTemplates($data['keyword'], $this->building_active_id);

        return view('template-send-resident.index', $data);
    }
    ...
    public function create()
    {
        ...
        return view('template-send-resident.create', $data);
    }
    ...
    public function store(MailTemplateCreateRequest $request)
    {
        ...
        return redirect()->action('System\TemplateSendResidentController@index');
    }
