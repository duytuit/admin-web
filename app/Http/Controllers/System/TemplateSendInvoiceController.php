...
class TemplateSendInvoiceController extends BuildingController
{
    ...
    public function index(Request $request)
    {
        ...
        $data['templates'] = $this->repository->getInvoiceTemplates($data['keyword'], $this->building_active_id);

        return view('template-send-invoice.index', $data);
    }
    ...
    public function create()
    {
        ...
        return view('template-send-invoice.create', $data);
    }
    ...
    public function store(MailTemplateCreateRequest $request)
    {
        ...
        return redirect()->action('System\TemplateSendInvoiceController@index');
    }
