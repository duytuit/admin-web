...
<div id="add-document-building" class="modal fade" role="dialog">
        ...
        <form action="POST" id="form-add-document-building" class="form-validate form-horizontal">
            ...
            <div class="modal-content">
                <div class="modal-header bg-primary">
                    ...
                    <h4 class="modal-title">Thêm mới tài liệu BQL</h4>
                </div>
                <div class="modal-body">
                    <div class="alert alert-danger alert_pop_add_document_building" style="display: none;">
                        <ul></ul>
                    </div>
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="title" id="title-document-building"
                                           class="form-control"
                                           placeholder="Tiêu đề"
                                    >
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <textarea name="description" id="description-document-building" class="form-control" cols="30" rows="5" placeholder="Mô tả"></textarea>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-sm-3">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary btn-js-action-add-document-building" form="form-add-verhicle" style="margin-right: 5px;"><i class="fa fa-save"></i>&nbsp;&nbsp;Xác nhận</button>
                </div>
            </div>
        </form>
    </div>
