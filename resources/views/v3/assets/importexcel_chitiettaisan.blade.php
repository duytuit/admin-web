...
@section('content')
    ...
    <section class="content-header">
        <h1>
            Import chi tiết tài sản
        </h1>
        <ol class="breadcrumb">
            <li><a href="{{ route('admin.home') }}"><i class="fa fa-home"></i> Trang chủ</a></li>
            <li class="active">Import chi tiết tài sản</li>
        </ol>
    </section>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">Import chi tiết tài sản</div>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            <form id="form_import_file" autocomplete="off" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <div class="form-group">
                                    <label for="ip-name">Chọn file thêm mới chi tiết tài sản</label>
    ...
    <script>
       ...
       $("#form_import_file").validate({
        ...
        async function import_excel() {
            ...
            var export_excel = await call_api_export(method, 'admin/asset/impAssetInfo' + param_query,form_data)
            var blob = new Blob(
                    [export_excel],
