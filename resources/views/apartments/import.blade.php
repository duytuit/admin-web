                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            {{-- @if( in_array('admin.apartments.import_apartment',@$user_access_router))
                                <form action="{{ route('admin.apartments.import_apartment') }}" method="post" id="form-import-apartment" autocomplete="off" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        @if( in_array('admin.apartments.download',@$user_access_router))
                                            <a class="btn btn-sm btn-success" title="File mẫu" href="{{ route('admin.apartments.download') }}"><i class="fa fa-download"></i> File mẫu</a>
                                        @endif
                                        @if( in_array('admin.apartments.index',@$user_access_router))
                                            <a class="btn btn-sm btn-success" title="Danh sách căn hộ" href="{{ route('admin.apartments.index') }}"><i class="fa fa-reply"></i> Danh sách căn hộ</a>
                                        @endif
                                    </div>
                                </form>
                            @endif --}}
                            @if( in_array('admin.apartments.import_update_apartment',@$user_access_router))
                                <form action="{{ route('admin.apartments.import_update_apartment') }}" method="post" id="form-import-update-apartment" autocomplete="off" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        @if( in_array('admin.apartments.download_file_update',@$user_access_router))
                                            <a class="btn btn-sm btn-success" title="File mẫu" href="{{ route('admin.apartments.download_file_update') }}"><i class="fa fa-download"></i> File mẫu</a>
                                        @endif
                                        @if( in_array('admin.apartments.index',@$user_access_router))
                                            <a class="btn btn-sm btn-success" title="Danh sách căn hộ" href="{{ route('admin.apartments.index') }}"><i class="fa fa-reply"></i> Danh sách căn hộ</a>
                                        @endif
