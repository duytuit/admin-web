...
@section('content')
    ...
    <section class="content">
        ...
        @endif
        <form
                action="{{ ($id == 0) ? action('System\ConfigSendForgotPassController@store') : action('System\ConfigSendForgotPassController@update', ['id' => $id]) }}"
                                    ...
                                    <div class="tab-pane active" id="partner">
                                        <div class="row">
                                            <div class="col-sm-12 col-xs-12 form-group div_title">
                                                <label class="control-label">Chọn trạng thái quên mật khẩu <span
