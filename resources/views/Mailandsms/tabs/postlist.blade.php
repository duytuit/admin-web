...
<section class="content">
        <div class="box box-primary" style="border-radius: 30px;" >
            <div class="box-body ">
                <?php $route = 'admin.history-notify.entire'; ?>
                ...
                <form id="form-posts" action="{{ route('admin.history-notify.entire') }}" method="post">
                    @csrf
                        ...
                        <table class="table table-hover table-striped table-bordered">
                            <thead class="bg-primary">
                                <tr>
                                    ...
                                    <th rowspan="2" class="text-center" width="100">Phân Loại</th>
                            ...
                            <tbody>
                                @foreach ($campains as $item)
                                    <tr valign="middle">
                                        ...
                                        <td rowspan="3">
                                            <a href="{{ route('admin.notification.campain-detail', ['id'=>$item->id]) }}" class="w-100 h-100">{{ $item->title }}</a>
                                            <details>
                                            <summary></summary>
                                            <p style="font-size: 30px;"> Chi Tiết </p>
                                            </details>
                                        </td>
