            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="box box-primary">
                        ...
                        <!-- /.box-header -->
                        <div class="box-body">
                            {!! Form::open(['url' =>[route('admin.provisionalreceipt.store',Request::all()) ] , 'method'=> 'POST','files' => true]) !!}
                                <div class="box-body no-padding">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-1">
                                            <a class="btn bg-gray" title="Danh sách" href="{{Request::has('type') ? route('admin.receipt.kyquy') : route('admin.receipt.index')}}"> Quay lại danh sách</a>
                                        </div>
                                    </div>
                                </div>
                            {!! Form::close() !!}
