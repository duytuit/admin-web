            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="box box-primary">
                        ...
                        <!-- /.box-header -->
                        <div class="box-body">
                            {!! Form::open(['url' =>[route('admin.provisionalreceipt.storePaymentSlip',Request::all()) ] , 'method'=> 'POST','files' => true]) !!}
                                <div class="box-body no-padding">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="customer_paid" id="customer_paid" value="">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-1">
                                            <a class="btn bg-gray" title="Quay lại danh sách" href="{{Request::has('type') ? route('admin.receipt.kyquy') : route('admin.receipt.index')}}">Quay lại danh sách</a>
                                        </div>
                                    </div>
                                </div>
                            {!! Form::close() !!}
