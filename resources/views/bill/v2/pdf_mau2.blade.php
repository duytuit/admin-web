    ...
    <div class="footer">
        <table style="width: 100%; padding: 10px" border="1">
            ...
            @if(count($debit_detail['service']) > 0)
                ...
                @endforeach
                <tr>
                    <td colspan="3" class="padding-tb"><b>Tổng phí dịch vụ</b></td>
            ...
            @endif
            <tr>
                <td colspan="3" class="padding-tb"><b>(A)TỔNG CỘNG</b></td>
                @php
            ...
            <tr>
                <td colspan="3" class="padding-tb"><b>(B)ĐÃ THANH TOÁN</b></td>
                <td class="padding-tb" style="text-align: right;">
                    @php
                        $paid = 0;    
            ...
            <tr>
                <td colspan="3" class="padding-tb"><b>(C)NỢ CŨ</b></td>
                @php
            ...
            <tr>
                <td colspan="3" class="padding-tb"><b>(D)DƯ CŨ</b></td>
                @php
            ...
            <tr>
                <td colspan="3" class="padding-tb"><b>(E)CẦN THANH TOÁN (A-B+C-D)</b></td>
