...
<section class="content">
    <div class="box box-primary">
        ...
        <div class="box-body">
            <form id="form-search-advance" action="{{route('admin.v2.receipttotal.index')}}" method="GET">
                <div id="search-advance" class="search-advance">
                    <div class="row form-group pull-right">
                        <div class=" col-md-12 ">
                            <a href="{{route('admin.v2.receipt.exportFilterSoQuyTienMat',Request::all())}}" class="btn btn-success">Xuất ra excel</a>
