    ...
    <section class="content">
        <div class="box box-primary">
            <div class="box-body">
                ...
                <form id="form-search-advance" action="{{ route('admin.company.listdepartment.listdepartment') }}" method="get">
                    <div id="search-advance" class="search-advance">
                        <div class="row form-group space-5">
                            ...
                            @if( in_array('admin.department.store', @$user_access_router))
                                <a href="" style="float: right;" data-toggle="modal" data-target="#createDepartment" class="btn btn-success"><i
                                    class="fa fa-users"></i>
                            Thêm bộ phận</a>
                            @endif
                            </div>
                ...
                <form id="form-departments" action="{{ route('admin.department.action') }}" method="post">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-striped table-bordered">
                            <thead style="background-color: black;" class="bg-primary">
                            <tr>
                                <th>STT</th>
                                <th>Tên Phòng Ban</th>
                                <th>Mã</th>
                                ...
                                @if($departments->count() > 0)
                                    @foreach($departments as $key => $department)
                                        <tr style="vertical-align: middle">
                                            ...
                                            <td><a href="{{ route('admin.department.show1', $department->id) }}">{{ @$department->name }}</a></td>
                                            <td>{{ @$department->code }}</td>
                                            <td>{{ @$department->phone }}</td>
                                            <td>{{ @$department->email }}</td>
                                            <td>
                                                {{ @$department->head_department->publicUser->BDCprofile->display_name }}
                                            </td>
                                            <td>
                                            ...
                                            <td style="text-align: center">
                                                <a style="background-color: black; border-color: black;" data-id="{{ $department->id }}" data-action="{{ route('admin.department.edit') }}"
                ...
                @include('department.modal.create_department1')
