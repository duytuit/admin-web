            ...
            <div class="box-body ">
                <div class="row form-group">
                    <div class="col-sm-12 pull-right">
                        <a href="{{ route('admin.users.create1') }}" class="btn btn-info"><i class="fa fa-edit"></i>
                           Thêm nhân viên</a>
                    </div>
                </div>
                <form id="form-search-advance" action="{{ route('admin.company.listemp.listemp') }}" method="get">
                            ...
                            @foreach ($users as $item)
                                <tr valign="middle">
                                    ...
                                    @if(in_array('admin.users.reset-pass',@$user_access_router))
                                        ...
                                        @if($_user->isadmin == 1)
                                            <a style="background-color: black; border-color: black;" href="{{ route('admin.users.edit',['id'=>$item->pub_user_id]) }}" class="btn btn-success" title="sửa"><i class="fa fa-edit"></i></a>
                                        @endif
