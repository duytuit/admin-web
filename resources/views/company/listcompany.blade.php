                                    ...
                                    <div class="box-header with-border">
                                        <div class="row form-group">
                                            <div class="col-md-2" style="float: right;">
                                                    <a href="javascript:;" type="button" style="background-color: black;" class="btn btn-primary show_edit"><i class="fa fa-plus"></i>&nbsp;&nbsp;Thêm công ty</a>
                                            </div>
                                        </div>
                                                    ...
                                                    @if($companys->count() > 0)
                                                        @foreach($companys as $key => $value)
                                                            <tr>
                                                                ...
                                                                <td>{{ @$value->name }}</td>
                                                                <td>
                                                                    <a style="background-color: black; border-color: black;" href="javascript:;" data-item="{{$value}}" class="btn btn-sm btn-primary show_edit"><i class="fa fa-edit"></i></a>
