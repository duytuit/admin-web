                ...
                <div class="col-md-12">
                    ...
                    <div class="nav-tabs-custom">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane {{ !str_contains(url()->current(),'tien-thua') ? 'active' : null }}" id="{{ route('admin.accounting.voucher.hach_toan') }}">
                                <div class="row form-group">
                                        <div class="col-12 col-md-8">
                                                <form id="form-search-advance" action="{{ route('admin.accounting.voucher.hach_toan') }}" method="get">
                                        ...
                                        <div class="col-12 col-sm-2">
                                            ...
                                            <a href="{{ route('admin.accounting.voucher.hach_toan.export') }}" class="btn btn-success"><i class="fa fa-edit"></i>Export</a>
                                        </div>
                                </div>
                                <form id="form-asset" action="{{ route('admin.accounting.voucher.hach_toan.action') }}" method="post">
                                        @csrf
