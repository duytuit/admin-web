...
@section('content')
    ...
    <section class="content">
        <div class="box box-primary">
            <div class="box-body">
                <form action="{{route('admin.service.building.postChoose')}}" method="post">
                    @csrf
                    ...
                    <div class="row form-group">
                        <div class="col-sm-4">
                            <a style="border: none" href="{{ route('admin.service.building.create') }}"><i
                        ...
                        <div class="col-sm-2 text-center">
                            <a href="{{ route('admin.service.building.index') }}" class="btn btn-warning"><i
