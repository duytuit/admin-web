                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group col-md-4">
                            {!! Form::open(['route' => ['admin.service.building.importApartmentService'], 'method'=> 'POST','files' => true]) !!}
                                {{ csrf_field() }}
                                ...
                                <div class="form-group">
                                    ...
                                    <a class="btn btn-sm btn-success" title="File mẫu" href="{{ route('admin.service.building.download') }}"><i class="fa fa-download"></i> File mẫu</a>
                                </div>
                                {!! Form::close() !!}
                        </div>
                    </div>
