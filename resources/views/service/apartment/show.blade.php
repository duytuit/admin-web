                ...
                <form>
                    <div class="form-group">
                        <div class="box-header with-border">
                            ...
                            <div class="col-md-2">
                                <a href="{{ route('admin.service.create') }}" class="btn btn-info"><i class="fa fa-edit"></i>
                                    Thêm mới</a>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div style="text-align: center" class="row form-group">
                            ...
                            <div class="col-sm-3">
                                <span><a href="{{ route('admin.service.resident.create') }}">1.xe ô tô: 29x-12548</a></span><br>
                                <span><a href="{{ route('admin.service.resident.create') }}">2.xe ô tô: 29x-12548</a></span><br>
                                <span><a href="{{ route('admin.service.resident.create') }}">3.xe ô tô: 29x-12548</a></span><br>
                            </div>
