...
@section('content')
    ...
    <section class="content">
        <div class="box-body">
            <form data-action="{{route('admin.service.apartment.store')}}" id="add_service" method="POST">
                @csrf
                <div class="row">
                    <!-- left column -->
                    <div class="col-md-6">
                        ...
                        <div class="box box-primary">
                            ...
                            <div class="box-body">
                                <div class="form-group div_bdc_apartment_id search-advance">
                                    ...
                                    <select class="form-control apartment-list selectpicker" name="bdc_apartment_id" data-live-search="true">
                                ...
                                <div hidden
                                    ...
                                    <select id="select-progressive" class="form-control col-xs-8" name="bdc_progressive_id">
                                        <option value="" selected>Mặc định của tòa nhà</option>
                                    </select>
                                    <div class="message_zone"></div>
                                </div>
                                <div hidden class="form-group floor_price div_floor_price">
                                    <label class="floor_price_1" for="exampleInputEmail1">Đơn giá / 1m<sup>2</sup> :</label>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $(document).on('change', '.service-list', function (e) {
                ...
                $.ajax({
                    url: '{{route('admin.service.apartment.getServiceApartmentAjax')}}',
                    type: 'POST',
                    data: {
                        id: id
                    },
