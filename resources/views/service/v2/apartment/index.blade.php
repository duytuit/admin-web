...
<section class="content-header">
    <h1>
        ...
        <small>Quản lý dịch vụ</small>
            <a href="{{route('admin.v2.service.apartment.create')}}" class="btn btn-success margin-r-5">
                <i class="fa fa-pencil-square-o" aria-hidden="true"></i> Thêm dịch vụ cho căn hộ </a>
            <a href="{{route('admin.v2.service.apartment.export',Request::all())}}"
    ...
    <div class="box box-primary">
        <div class="box-body">
            <div class="row form-group">
                <form action="{{route('admin.v2.service.apartment.index')}}" method="GET">
                        ...
                        <div class="col-sm-1">
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    ...
                                    <a href="javascript:" type="button" class="btn-action"
                                        data-target="#form-service-apartment-action" data-method="update_status">
                                        <i class="fa fa-edit text-green"></i>&nbsp; Cập nhật trạng thái
                                    </a>
                                    <a href="javascript:" type="button" class="btn-action"
                    ...
                    <div class="col-sm-2">
                        <input type="text" class="form-control date_picker" name="ngay_tinh_phi"
                            placeholder="Ngày tính phí" value="{{@$filter['ngay_tinh_phi']}}">
                    </div>
                    <div class="col-sm-1">
                        <select name="status" id="status_service" class="form-control">
                            <option value="" selected>-- Trạng thái --</option>
                            <option value="0" @if(@$filter['status'] === 0) selected @endif>Inactive</option>
                            <option value="1"  @if(@$filter['status'] === 1) selected @endif>Active</option>
                        </select>
                    </div>
                    <div>
            ...
            <div class="table-responsive">
                @if( in_array('admin.v2.service.apartment.action',@$user_access_router))
                <form action="{{ route('admin.v2.service.apartment.action') }}" method="post"
                        ...
                        <tbody>
                            ...
                            <tr @if($apartmentService->deleted_at != null) class="danger" style="text-decoration:
                                ...
                                <td>
                                    ...
                                    <div class="onoffswitch">
                                        <input type="checkbox" name="onoffswitch" class="onoffswitch-checkbox"
                                            ...
                                            data-url="{{ route('admin.v2.service.apartment.status') }}"
                                ...
                                <td>
                                    @if ($apartmentService->deleted_at == null)
                                    <a style="float: left"
                                        href="{{ route('admin.v2.service.apartment.edit', ['id' => @$apartmentService->id]) }}"
                                        class="btn btn-sm btn-warning margin-r-5"><i class="fa fa-edit"></i></a>
                                    @if( in_array('admin.v2.service.apartment.destroy',@$user_access_router))
                                    <a href="{{ route('admin.v2.service.apartment.destroy', ['id' => @$apartmentService->id]) }}"
