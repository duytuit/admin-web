...
@section('content')
    ...
    <section class="content">
        <div class="box-body">
            <form data-action="{{route('admin.v2.service.apartment.update',$apartmentService->id)}}" id="add_service"
                  method="POST">
                @method('PUT')
                @csrf
                <div class="row">
                        ...
                        <div class="box box-primary">
                            ...
                            <div class="box-body">
                                ...
                                <div @if(@$apartmentService->service->servicePriceDefault->priceType->id == \App\Repositories\Service\MANY_PRICE | $apartmentService->service->type == \App\Repositories\BdcApartmentServicePrice\FLOOR_PRICE )
                                    ...
                                    <input readonly id="price" type="number" name="price" step="any" min="0" class="form-control"
                                           value="{{ $apartmentService->price }}">
                                    <div class="message_zone"></div>
                                </div>
                                ...
                                <div @if(@$apartmentService->service->type != \App\Repositories\BdcApartmentServicePrice\FLOOR_PRICE)
                                    ...
                                    <input id="floor_price" type="number" name="floor_price" readonly class="form-control"
