                ...
                <div class="row">
                    <div class="col-sm-2 col-xs-12" style="padding-right: 0;">
                        <select class="form-control" name="feedback" id="select-feedback" style="width: 100%;">
                            <option value="" @if(isset($data_search['feedback']) && $data_search['feedback'] == '') selected @endif>Chọn trạng thái</option>
...
{{--                                @endcan--}}
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>@if(!empty($content['customer_phone']) && $phone_num_new != $phone_num) <span class="text_line_through">{{$phone_num}}</span> -> {{$phone_num_new}} @elseif(!empty($content['customer_phone']) && $phone_num_new == $phone_num) {{$phone_num}}@else {{$phone_num}} @endif</td>
...
{{--                                <td class="text-uppercase">{{ $assign->source ?: '' }} </td>--}}
                                ...
                                <td>
                                    ...
                                    @if ($assign->status !== null)
                                        @can('update', app(App\Models\CampaignAssign::class))
                                            @if($status_his == 0)
                                ...
                                <td>
                                    ...
                                    @else
{{--                                    @can('index', app(App\Models\CustomerDiary::class))--}}
                                        <a href='javascript:;' class="btn btn-sm btn-success js-btn-add-edit-diary" title="Chi tiết" data-assign='{{$assign->id}}' data-toggle="modal" data-target="#campaign-assign-diary">
                                            <i class="fa fa-window-restore "></i>
                                        </a>
                                        <a href='javascript:;' class="btn btn-sm btn-facebook check_cus_add" title="Duyệt" data-assign='{{$assign->id}}' >
                                            <i class="fa fa-check-square-o"></i>
                                        </a>
                                        {{--<a href='javascript:;' class="btn btn-sm btn-danger check_cus_del" title="Hủy" data-assign='{{$assign->id}}' >
                                            <i class="fa fa-check-square-o"></i>
                                        </a>--}}
{{--                                    @endcan--}}
                                    @endif
