...
@section('content')
    ...
    <section class="content-header">
        <h1>
            Danh sách gửi thông báo cho khách hàng
        </h1>
        <ol class="breadcrumb">
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover table-striped table-bordered">
                                ...
                                <tr>
                                    ...
                                    <th >Căn hộ nhận thông báo</th>
                                    <th width="125">Danh mục</th>
                                    <th width="125">Người tạo</th>
...
{{--                                        <td>{{ $item->category ? $item->category->title : '' }}</td>--}}
                                        <td>
                                          @if($item->lists_notify_apartment)
                                            @php
                                                $lists_notify = json_decode($item->lists_notify_apartment,true) ?? [];
                                            @endphp
                                                @foreach ($lists_notify as $lists_notify_apartment_value)
                                                    @foreach ($customers_v2 as $apartment_v2_value)
                                                       @if($lists_notify_apartment_value == $apartment_v2_value->id)
                                                          <span class="label label-success" style="margin-right: 5px;"> {{$apartment_v2_value->bdcApartment->name}} </span> 
                                                       @endif
                                                    @endforeach
                                                @endforeach
                                           @endif
