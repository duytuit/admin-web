                            ...
                            <div class="box-body no-padding">
                                <div class="col-sm-6">
                                    ...
                                    <div class="col-sm-12 col-xs-12 form-group {{ $errors->has('password') ? 'has-error': '' }}">
                                        <label class="control-label">Mật khẩu (ít nhất 8 kí tự trong đó có ít nhất 1 ký tự chữ và số) <span class="text-danger">*</span></label>
                                        <input type="password" class="form-control" name="password" placeholder="Mật khẩu" value="" autocomplete="off"/>
                                ...
                                <div class="col-sm-6">
                                    <div class="col-sm-12 col-xs-12 form-group {{ $errors->has('ub_account_tvc') ? 'has-error': '' }}">
                                        ...
                                        <input type="text" class="form-control" name="ub_account_tvc" placeholder="Tên đăng nhập" value="{{ $bo_user->ub_account_tvc ?? old('ub_account_tvc') ?? ''}}"/>
                                        @if ($errors->has('ub_account_tvc'))
                                            <em class="help-block">{{ $errors->first('ub_account_tvc') }}</em>
                                        @endif
                                    </div>
                                    <div class="col-sm-12 col-xs-12 form-group {{ $errors->has('group_ids') ? 'has-error': '' }} hidden">
                                        <label class="control-label">Phòng ban <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" name="group_ids" placeholder="Phòng ban" value="1536572739"/>
...
{{--                                        </select>--}}
                                    ...
                                    <div class="col-sm-12 col-xs-12 form-group {{ $errors->has('ub_tvc_code') ? 'has-error': '' }} hidden">
                                    ...
                                    <div class="col-sm-12 col-xs-12 form-group {{ $errors->has('confirm_password') ? 'has-error': '' }}">
                                        ...
                                        <input type="password" class="form-control" name="confirm_password" placeholder="Nhập lại mật khẩu" value="" autocomplete="off"/>
                                        @if ($errors->has('confirm_password'))
                                            <em class="help-block">{{ $errors->first('confirm_password') }}</em>
                                        @endif
                                    </div>
                                    <input type="hidden" class="form-control" name="u_type" placeholder="Loại NV" value="1"/>
                                </div>
