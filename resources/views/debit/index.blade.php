            ...
            <div class="box-body">
                <div class="row form-group pull-right">
                    <div class=" col-md-12 ">
                        ...
                        ?>
                        <a href="{{ route('admin.debit.exportFilter') }}{{$param}}" class="btn bg-olive"><i class="fa fa-file-excel-o"></i>
                            Export excel</a>
                ...
                <form id="form-search-advance" action="{{route('admin.debit.index')}}" method="get">
                            ...
                            @foreach($debits as $key => $debit)
                                <tr>
                                    ...
                                    <td>@foreach(@$debit->apartment->bdcCustomers as $value)
                                            ...
                                            @endif
                                        @endforeach</td>
                                    <td><a href="{{route('admin.debit.show',$debit->bdc_apartment_id)}}">{{@$debit->apartment->name}}</a></td>
                ...
                @endphp
                <a href="{{route('admin.debit.detail', ['month' => $month])}}" class=""><h4><i class="fa fa-hand-o-right"
                                                                                     aria-hidden="true"></i>
