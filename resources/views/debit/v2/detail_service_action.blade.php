...
@section('content')
    ...
    <section class="content">
        <div class="box box-primary">
            ...
            <div class="box-body">
                <form id="form-search-advance" action="{{route('admin.v2.debit.detail_service_action')}}" method="get">
                    <div id="search-advance" class="search-advance">
                        <div class="row space-5">
                            ...
                            <div class="col-sm-2">
                                ...
                                ?>
                                <a class="btn btn-info" href="{{ route('admin.v2.debit.exportExcel') }}{{ $param }}">Export</a>
                            </div>
                ...
                <form id="form-permission" action="{{ route('admin.v2.debit.detail-service.action_record') }}" method="post">
                    @csrf
                        ...
                        <table class="table table-hover table-striped table-bordered">
                            ...
                            @if($debits->count() > 0)
                                ...
                                <tr>
                                    ...
                                    <td>
                                       @if( in_array('admin.v2.debit.detailDebit.edit.version',@$user_access_router))
                                        <a>
                                            {{ @$debit->bill_code }}
                                        </a>
                                       @endif
