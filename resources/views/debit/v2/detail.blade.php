    ...
    <section class="content">
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <form id="form-search-advance" action="{{route('admin.v2.debit.detail')}}" method="get">
                ...
                <form id="form-permission" action="{{ route('admin.v2.debit.detail.action') }}" method="post">
                    @csrf
