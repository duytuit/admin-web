...
{{--                        <form id="form-search-service" action="{{route('admin.v2.debit.show',$apartment->bdc_apartment_id)}}" method="get">--}}
...
{{--                        </form>--}}
                    ...
                    <div class="col-sm-4">
                        <a href="{{route('admin.v2.debit.exportShow',$apartment->bdc_apartment_id)}}"
