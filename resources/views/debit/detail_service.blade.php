...
@section('content')
    ...
    <section class="content">
        <div class="box box-primary">
            ...
            <div class="box-body">
                <form id="form-search-advance" action="{{route('admin.debit.detailDebit')}}" method="get">
                    <div id="search-advance" class="search-advance">
                        <div class="row space-5">
                            ...
                            <div class="col-sm-2">
                                ...
                                ?>
                                <a class="btn btn-info" href="{{ route('admin.debit.exportExcel',Request::all()) }}">Export</a>
                            </div>
                        </div>
                    </div>
                </form>
                <form id="form-permission" action="{{ route('admin.debit.detail-service.action') }}" method="post">
                    @csrf
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-hover table-striped table-bordered">
                            ...
                            @if($debits->count() > 0)
                                ...
                                <tr>
                                    <td>
                                       @if( in_array('admin.debit.detailDebit.edit',@$user_access_router))
                                       @if($debit->paid == 0 || \Auth::user()->isadmin == 1)
                                        ...
                                        @if($debit->status < 0 || \Auth::user()->isadmin == 1)
                                         <a href="{{ route('admin.debit.detailDebit.delete',['id'=> $debit->id]) }}"
                                    ...
                                    @php
                                        if(@$debit->new_sumery == 0) {
                                            ...
                                            $dathu = @$debit->sumery - @$debit->new_sumery + @$debit->paid_v3;
                                            $conno = @$debit->new_sumery - @$debit->paid_v3;
                                        }
                                    @endphp
