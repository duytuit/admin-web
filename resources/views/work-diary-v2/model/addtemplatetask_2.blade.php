<div class="modal fade" id="addtemplatetotask_2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" style="padding-right:0px;" aria-hidden="true">
    <div class="modal-dialog addtemplatetotask_2" role="document" style="padding: 20px 0; margin-top: 30px;">
        <div class="modal-content" style="border-radius: 5px;min-height: 250px">
            ...
            <div class="modal-body" class="col-sm-12" style="padding:0;">
                ...
                <form class="form-horizontal" action="" method="POST" id="modal-templatetotask">
                    ...
                    <div class="box-body template_overflow_y">
                        <div class="row">
                            <div class="col-sm-12">
                                <label for="recipient-name" class="control-label"><span style="color:red;font-size: 18px;">*</span>Chọn Checklist mẫu</label>
                                <select name="title" id="title_task_template" class="form-control" multiple style="width: 100%">
