...
@section('content')
    ...
    <section class="content">
        ...
        @endif
        <form
                action="{{ ($id == 0) ? action('System\TemplateSendFotgotPassController@store') : action('System\TemplateSendFotgotPassController@update', ['id' => $id]) }}"
                                        ...
                                        <div class="row">
                                            <div class="col-md-8">
                                                ...
                                                <div class="col-md-8" style="margin: 10px">
                                                    <p>@tennhanvien (Tên khách hàng)</p>
                                                    <p>@pass (Mật khẩu)</p>
                                                    <p>@ngay (Ngày tháng)</p>
                                                    <p>@urlLogin (Đường dẫn đăng nhập)</p>
                                                </div>
                                            </div>
                                        </div>
