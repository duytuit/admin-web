            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <form action="{{route('admin.vehiclecategory.update',['id'=>$vehiclecate->id])}}" method="post" id="form-edit-vehiclecate">
                            {{ csrf_field() }}
                            <div class="col-sm-6">
...
{{--                                               value="{{ isset($service) ? $service->first_time_active : old('first_time_active') }}"--}}
