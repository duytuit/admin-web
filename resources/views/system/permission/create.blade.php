...
<div class="container-fluid">
    <div class="row">
        ...
        @endif
        {!! Form::open(['url' =>[route('admin.system.permission.store') ] , 'method'=> 'POST','files' => true]) !!}
          <div class="form-group">
            {!! Form::label('title', 'Permission name') !!}
            {!! Form::text('title', old('title'), ['class' => 'form-control', 'placeholder' => 'Permission name']) !!}
          </div>
          {{-- name --}}

          <div class="form-group">
            {!! Form::label('route_name', 'Router name') !!}
            {!! Form::text('route_name', old('route_name'), ['class' => 'form-control', 'placeholder' => 'Router name']) !!}
          </div>
          {{-- route_name --}}
          <div class="form-group">
            {!! Form::label('module_id', 'Menus') !!}
            {!! Form::select('module_id', $menus, old('module_id')? old('module_id'):0, ['class' => 'form-control']) !!}
          </div>
          ...
          {{-- module_id --}}
            ...
            <div class="form-group">
                ...
                <div class="radio">
                    <label for="has_menu"> <input name="has_menu" type="radio" value="0" id="has_menu" {{ old('has_menu') == 0 ? 'checked' : ''}}> No</label>
                </div>
                <div class="radio">
                    <label for="has_menu"><input name="has_menu" type="radio" value="1" id="has_menu" {{ old('has_menu') == 1 ? 'checked' : ''}}> Yes</label>
                </div>
            </div>
          {{-- has_menu --}}
