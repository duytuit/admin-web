        ...
        <div class="row">
            <div class="box-body">
                                ...
                                <div class="box-header with-border">
                                    <div class="row form-group">
                                        <div class="col-sm-8 col-xs-12 ">
                                            <a href="{{ action('System\TemplateSendInvoiceController@create') }}" type="buttom" class="btn btn-info"><i
                ...
                <span class="btn-group">
                    <a data-action="{{ action('System\TemplateSendInvoiceController@ajaxDeleteMulti') }}" class="btn btn-danger"
                                                ...
                                                @if($templates->count())
                                                    @foreach($templates as $key => $template)
                                                        <tr>
                                                            ...
                                                            <td>{{ $template->name }}</td>
                                                            <td>
                                                                <a href="{{ action('System\TemplateSendInvoiceController@edit', ['id' => $template->id]) }}" type="button"
                                                                   class="btn btn-sm btn-info" title="Sửa"><i class="fa fa-edit"></i></a>

                                                                <a title="Xóa" href="javascript:;"
                                                                   data-url="{{ action('System\TemplateSendInvoiceController@destroy', ['id' => $template->id] ) }}" data-id="{{ $template->id }}"
