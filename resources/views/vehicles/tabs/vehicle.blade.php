<div class="panel panel-default">
    {{--                            <div class="panel-heading">Danh sách phương tiện</div>--}}
    ...
    <div class="panel-body">
        <div class="box box-primary">
            <div class="box-body ">
                    ...
                    <div class="row">
                        <div class="col-sm-2">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <a href="javascript:" type="button" class="btn-action" data-target="#form-vehicles-list" data-method="delete">
                ...
                @if( in_array('admin.vehicles.action',@$user_access_router))
                    <form id="form-vehicles-list" action="{{ route('admin.vehicles.action') }}" method="post">
                        @csrf
                            ...
                            <table class="table table-hover table-striped table-bordered">
                                ...
                                @foreach($vehicles as $v)
                                    ...
                                    <tr @if($v->deleted_at != null) class="danger" style="text-decoration: line-through;" @endif>
                                        ...
                                        <td>{{@$apartmentServicePrice->first_time_active ? date('d-m-Y',strtotime(@$apartmentServicePrice->first_time_active)) : ''}}</td>
                        ...
                        <div class="row mbm">
                            <div class="col-sm-3">
                                <span class="record-total">Hiển thị: {{$display_count}} / {{ $vehicles->total() }} kết quả</span>
                            </div>
        ...
        @include('vehicles.modals.add-vehicle')
    </div>
</div>
