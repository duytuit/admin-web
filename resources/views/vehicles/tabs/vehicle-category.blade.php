...
{{--                                    @endif--}}
                                    <div class="onoffswitch">
                                        <input type="checkbox"
                                               ...
                                               data-url="{{ route('admin.vehiclecategory.status') }}"
                ...
                <div class="row mbm">
                    <div class="col-sm-3">
                        <span class="record-total">Hiển thị: {{$display_count_cate}} / {{ $vehiclecates->total() }} Kết quả</span>
                    </div>
        ...
        @include('vehicles.modals.add-vehicle-category')
    </div>
</div>
