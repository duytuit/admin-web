                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            <form action="{{ route('admin.vehicles.importExcel') }}" method="post" id="form-import-vehicle" autocomplete="off" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    @if( in_array('admin.vehicles.download',@$user_access_router))
                                        <a class="btn btn-sm btn-success" title="File mẫu" href="{{ route('admin.vehicles.download') }}"><i class="fa fa-download"></i> File mẫu</a>
                                    @endif
                                    @if( in_array('admin.vehicles.index',@$user_access_router))
                                        <a class="btn btn-sm btn-success" title="Danh sách phương tiện" href="{{ route('admin.vehicles.index') }}"><i class="fa fa-reply"></i> Danh sách phương tiện</a>
                                    @endif
                                </div>
                            </form>
                            {{--                            {{$messages}}--}}
