...
@section('content')
    ...
    <section class="content-header">
        <h1>
            Phương tiện
            @if( in_array('admin.v2.vehicles.index_import',@$user_access_router)) <a href="{{ route('admin.v2.vehicles.index_import') }}" class="btn btn-success"><i class="fa fa-file-excel-o"></i>&nbsp;&nbsp;Import Exel</a> @endif
            <a href="{{ route('admin.v2.vehicles.export',Request::all()) }}" class="btn btn-success"><i class="fa fa-pencil-square-o"></i>&nbsp;&nbsp;Xuất ra Excel</a>
            <a href="{{ route('admin.v2.vehicles.report_export',Request::all()) }}" class="btn btn-success"><i class="fa fa-pencil-square-o"></i>&nbsp;&nbsp;Báo cáo tổng hợp phương tiện</a>
            <a class="btn btn-success open_export_choppy_vehicle" ><i class="fa fa-pencil-square-o"></i>&nbsp;&nbsp;Biến động phương tiện theo loại</a>
            ...
            <div class="col-md-12">
                ...
                <div class="tab-content">
                    <div class="tab-pane {{$tab==''?'active':''}}" id="general" style="padding: 15px 0;">
                        @include('vehicles.v2.tabs.vehicle')
                    </div>
                    <div class="tab-pane {{$tab=='Category'?'active':''}} " id="category" style="padding: 15px 0;">
                        @include('vehicles.v2.tabs.vehicle-category')
                    </div>
                </div>
            </div>
        </div>
...
@section('javascript')
    ...
    <script>
        ...
        $('.open_export_choppy_vehicle').click(function (e) { 
            e.preventDefault();
            $('#search_choppy_vehicle').modal('show');
        });
        $(function () {
