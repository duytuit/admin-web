...
{{--                                    </div>--}}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date"
                                               ...
                                               id="finish"
                                               name="finish"
                                               value="{{ Request::get('finish') ? Request::get('finish') : (isset($vehicle)? $vehicle->finish:'')}}"
                                        >
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="checkbox" name="status" value="1" {{$vehicle->status===1?'checked':''}}>
                                    </div>
                                </div>
    ...
    <script>
        $(function () {
            ...
            $(".btn-js-action-vehicle").on('click',function () {
                ...
                $.get('{{ route('admin.v2.vehicles.ajax_check_number') }}', {
                    type: vehicle_number,
                    id: {{$id}}
                }, function(data) {
                    if(data.status == 1){
