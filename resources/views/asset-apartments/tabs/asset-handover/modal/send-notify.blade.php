<div class="modal fade" id="send_notify_apartment" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" style="padding-right:0px;display:none" aria-hidden="true">
    <div class="modal-dialog shift" role="document" style="padding: 20px 0;">
        <div class="modal-content" style="border-radius: 5px;">
            ...
            border-bottom: 0;
            ">
                <h5 class="modal-title" style="margin-top: 2px;">Gửi thông báo bàn giao tài sản căn hộ tới khách hàng</h5>
            ...
            <div class="modal-body" class="col-sm-12" style="padding:0;">
                ...
                <input type="hidden" name="asset_handover_ids" id="asset_handover_ids">
                    <div class="row">
                        <div class="col-sm-8">
                                <div class="box-body">
                                        ...
                                        <div class="form-group" id="form_mac_dinh">
                                            <div>Quy KH <strong>@khachhang</strong> du kien se nhan ban giao tai san <strong>@taisan</strong> can ho <strong>@canho</strong> vao ngay <strong>@ngaybangiao</strong>. Tran trong ./.</div>
                                        </div>
                                </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="box box-primary">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group" id="private" >
                                        <label class="control-label">Khách hàng nhận tin thông báo</label>
                                        <div class="notify-group">
                                            ...
                                            <div id="notify-customer">
                                                <select id="ip_apartment_send_notify" style="width:100%" multiple class="form-control select2">
                                                    ...
                                                    @foreach($list_apartments as $key => $value)
