                ...
                <div class="row">
                            ...
                            <div class="box-body">
                                    ...
                                    <select class="form-control" name="bdc_assets_type_id">
                                        ...
                                        @foreach($types as $key => $type)
                                            <option value="{{ $type->id }}"
                                                    @if((old('bdc_assets_type_id') ?? @$asset->bdc_assets_type_id) == $type->id) selected @endif>{{ $type->name }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-8 {{ $errors->has('using_peroid') ? ' has-error' : '' }}">
                                            <input type="number" class="form-control" min="1" name="using_peroid"
                                                   value="{{ old('using_peroid') ?? @$asset->using_peroid }}">
                                ...
                                <div class="form-group {{ $errors->has('warranty_period') ? ' has-error' : '' }}">
                                    ...
                                    <div class="input-group date">
                                        ...
                                        <input type="text" class="form-control pull-right date_picker" name="warranty_period" value="{{ old('warranty_period') ?? @$asset->warranty_period }}">
                                    </div>
                        ...
                        <div class="box box-primary">
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-8 {{ $errors->has('price') ? ' has-error' : '' }}">
                                            <input type="text" class="form-control" maxlength="15" name="price"
                                                   value="{{ old('price') ?? number_format(@$asset->price) }}">
                                            @if ($errors->has('price'))
                                                <span class="help-block">
                                ...
                                <div class="form-group {{ $errors->has('buying_date') ? ' has-error' : '' }}">
                                    ...
                                    <div class="input-group date">
                                        ...
                                        <input type="text" class="form-control pull-right date_picker"
                                               name="buying_date" value="{{ old('buying_date') ?? $asset->buying_date }}">
                                    </div>
                                ...
                                <div class="form-group {{ $errors->has('buyer') ? ' has-error' : '' }}">
                                    ...
                                    <input type="text" name="buyer" class="form-control" value="{{ old('buyer') ?? @$asset->buyer }}">
                                    @if ($errors->has('buyer'))
                                        <span class="help-block">
                                ...
                                <div class="form-group {{ $errors->has('place') ? ' has-error' : '' }}">
                                    ...
                                    <input type="text" name="place" class="form-control" value="{{ old('place') ?? @$asset->place }}">
                                    @if ($errors->has('place'))
                                        <span class="help-block">
                                ...
                                <div class="form-group {{ $errors->has('bdc_period_id') ? ' has-error' : '' }}">
                                    ...
                                    <select class="form-control" name="bdc_period_id">
                                        ...
                                        @foreach($periods as $key => $type)
                                            <option value="{{ $type->id }}"
                                                    @if((old('bdc_period_id') ?? @$asset->bdc_period_id) == $type->id) selected @endif>{{ $type->name }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group {{ $errors->has('maintainance_date') ? ' has-error' : '' }}">
                                    ...
                                    <div class="input-group date">
                                        ...
                                        <input type="text" class="form-control pull-right date_picker"
                                               name="maintainance_date" value="{{ old('maintainance_date') ?? @$asset->maintainance_date }}">
                                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group {{ $errors->has('asset_note') ? ' has-error' : '' }}">
                            <label>Ghi chú</label>
                            <textarea id="content" class="mceEditor form-control" rows="10"
                                      name="asset_note">{!! old('asset_note') ?? @$asset->asset_note !!}</textarea>
                        ...
                        <div class="box-footer">
                            <a href="{{ route('admin.assets.index') }}" type="button"
