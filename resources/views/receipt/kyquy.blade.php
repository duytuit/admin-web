    ...
    <div class="box box-primary">
        <div class="box-body font-weight-bold">
            ...
            <div class="pull-right">
                ...
                ?>
                <a href="{{route('admin.v2.receipt.exportFilterReceiptDeposit',Request::all())}}" class="btn btn-success">Xuất ra excel</a>
        ...
        <div class="box-body">
            <form id="form-search-advance" action="{{route('admin.receipt.kyquy')}}" method="get">
                    ...
                    <tbody>
                        @foreach($receipts as $lock => $receipt)
                            <tr @if($receipt->deleted_at != null) class="danger" style="text-decoration: line-through;" @endif>
                                ...
                                <td>
                                    @if($receipt->vnp_transactionno == 'phieu_thu_chi')
                                    ...
                                    @else
                                    <a style="float: left" href="{{ asset("/$receipt->url") }}" target="_blank"
                                        class="btn btn-sm btn-info margin-r-5"><i class="fa fa-print"></i></a>
                                    @endif
                                </td>
                            </tr>
