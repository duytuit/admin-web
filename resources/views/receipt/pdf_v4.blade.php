            ...
            <div class="content_text">
                <div class="list_content_text">
                    <table width="70%">
                        ...
                        @if(@$receipt->type != 'phieu_ke_toan' || @$receipt->type == 'phieu_dieu_chinh')
                        <tr>
                        ...
                        <table>
                            ...
                            {{--@if(empty($listService))
                                ...
                                @foreach ($listService as $key => $_listService)
                                    <?php
                                        $_listService =(object)$_listService;
                                        $service = $serviceRepository->findServiceV2(@$_listService->bdc_service_id);
                                        $name = null;
                                        $check = explode('-',@$service->name);
                                        if(count($check) > 2){
