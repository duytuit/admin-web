                            ...
                            <form role="form" id="receipt_form">
                                <div class="box-body no-padding">
                                    ...
                                    <div class="form-group paid_money">
                                        ...
                                        <input type="hidden" class="form-control customer_paid_string" value="0"  name="customer_paid_string" id="customer_paid_string" readonly="readonly">
                                    </div>
                                    <div class="form-group paid_money">
                                    ...
                                    <div class="form-group">
                                        <button type="button" style="margin:5px 5px" class="btn bg-gray print_and_collect_money" data-url="{{ route('api.receipts.index') }}" data-url-main="{{ route('admin.receipt.index') }}">Thu và In</button>
                                        <button type="button" style="margin:5px 5px" class="btn bg-gray collect_money" data-url="{{ route('api.receipts.index') }}" data-url-main="{{ route('admin.receipt.index') }}">Thu tiền</button>
                                        <button type="button" style="margin:5px 5px" class="btn bg-gray collect_money_review" data-url="{{ route('api.receipts.index') }}" data-url-main="{{ route('admin.receipt.index') }}">Xem trước</button>
                                    </div>
                                </div>
                            </form>
                        </div>
...
<script>
    ...
    $('.debit_detail_content').on('keyup','input.tien_phat_sinh', function(e){   
        $(this).val(formatCurrency(this));
    }).on('keypress','input.tien_phat_sinh',function(e){
