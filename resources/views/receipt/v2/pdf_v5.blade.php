                            ...
                            <tbody>
                                ...
                                @foreach ($listService as $key => $_listService)
                                   @if (@$_listService->cost)
                                        <tr>
                                            <td>{{ $key + 1 }}</td>
                                            <td>{{ @$_listService->service->name }}</td>
                                            <td>{{ @$_listService->debitdetail->title }}</td>
                                            <td>{{ number_format($_listService->debitdetail->sumery, 0, '', '.') }}</td>
                                                @if(@$_listService->debitdetail->bdc_price_type_id == 2)
                                                <td>{{ date('d/m/Y', strtotime(@$_listService->debitdetail->from_date)) . "-" . date('d/m/Y', strtotime(@$_listService->debitdetail->to_date)) }}</td>
                                                @else
                                                <td>{{ date('d/m/Y', strtotime(@$_listService->debitdetail->from_date)) . "-" . date('d/m/Y', strtotime(@$_listService->debitdetail->to_date . ' - 1 days')) }}</td>    
                                                @endif
