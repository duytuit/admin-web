...
<div class="invoice">
    <div style=" text-align: center;">
        ...
        @elseif(@$receipt->type == 'phieu_thu_ky_quy')
        <p class="text-invoice">Phiếu thu ký quỹ</p>
        @elseif(@$receipt->type == 'phieu_hoan_ky_quy')
        <p class="text-invoice">Phiếu hoàn ký quỹ</p>
        @else
    ...
    <div class="content_text">
        <div class="list_content_text">
            <table width="70%">
                ...
                @if(@$receipt->type == 'phieu_thu' || @$receipt->type == 'phieu_thu_truoc' || @$receipt->type == 'phieu_chi' || @$receipt->type == 'phieu_chi_khac' || @$receipt->type == 'phieu_bao_co' || @$receipt->type == 'phieu_thu_ky_quy' || @$receipt->type == 'phieu_hoan_ky_quy')
                <tr>
                    <td align="left">Số tiền:</td>
                    <td width="65%"><b>{{ number_format(@$receipt->cost) }}</b> <b>VND</b></td>
                </tr>
                <tr>
