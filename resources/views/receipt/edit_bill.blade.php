                                ...
                                <div class="box-body no-padding">
                                    ...
                                    @if($receipt->type == "phieu_thu_truoc")
                                        <div class="form-group row">
                                            <div class="col-md-4">
                                                <button type="button" class="btn bg-gray update_print_and_collect_money" data-url="{{ route('api.receipts.index') }}" data-url-main="{{ route('admin.receipt.index') }}">Thu và In</button>
                                            </div>
                                            <div class="col-md-4">
                                                <button type="button" class="btn bg-gray update_collect_money" data-url="{{ route('api.receipts.index') }}" data-url-main="{{ route('admin.receipt.index') }}">Thu tiền</button>
                                            </div>
                                        </div>
                                    @endif
                                </div>
