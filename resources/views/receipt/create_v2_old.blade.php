            ...
            <div class="row">
                    ...
                    <div class="box box-primary" style="box-shadow: none;">
                        ...
                        <div class="box-body no-padding">
                            <div class="row box-body" style="display: flex;justify-content: center;color: red;">
                                  {{-- <label>Căn hộ có tiền thừa hạch toán : 200000 VND !</label> --}}
                            </div>
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="box-body">
                                        <form role="form">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control selectpicker" data-live-search="true" id="choose_apartment_v2_old" data-url="{{ route('api.receipts.index') }}">
                                ...
                                <div class="col-md-4">
                                    <div class="box-body">
                                        <form role="form">
                                            ...
                                            <div class="form-group">
                                                <label>Số tiền</label>
                                                <input type="text" class="form-control customer_paid_string" value="0"  name="customer_paid_string" id="customer_paid_string" readonly>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                ...
                <div class="bottom-control" style="bottom: 0;position: fixed;width: 85%;">
                    <div class="main-action container-fluid align-items-center control-item " style="display: flex;justify-content: center;">
                            ...
                            <button type="button" class="btn btn-success mr-l add_new_debit_detail_v2_old" data-toggle="modal" data-target="#createDebitDetail" data-url="{{ route('api.debit.index') }}">Thêm mới công nợ</button>
                            <button type="submit" class="btn btn-primary mr-l print_and_collect_money_v2_old" id="thu_va_in" data-url="{{ route('api.receipts.index') }}" data-url-main="{{ route('admin.receipt.index') }}"><i class="bx bx-save"></i><span class="align-middle ml-25">Thu và in</span></button>
                            <button type="submit" class="btn btn-info mr-l collect_money_v2_old" id="thu_tien" data-url="{{ route('api.receipts.index') }}" data-url-main="{{ route('admin.receipt.index') }}"><i class="bx bx-save"></i><span class="align-middle ml-25">Thu tiền</span></button>
                            <button type="submit" class="btn btn-success mr-l collect_money_review_v2_old" id="xem_truoc" data-url="{{ route('api.receipts.index') }}" data-url-main="{{ route('admin.receipt.index') }}"><i class="bx bx-save"></i><span class="align-middle ml-25">Xem trước</span></button>
                    </div>
                </div>
            </div>
        </div>
