                            ...
                            <form role="form" id="receipt_form">
                                <div class="box-body no-padding">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-4">
                                            <button type="button" class="btn bg-gray print_and_collect_money" data-url="{{ route('api.receipts.index') }}" data-url-main="{{ route('admin.receipt.index') }}">Chi và In</button>
                                        </div>
                                        <div class="col-md-4">
                                            <button type="button" class="btn bg-gray collect_money" data-url="{{ route('api.receipts.index') }}" data-url-main="{{ route('admin.receipt.index') }}">Chi trả</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
