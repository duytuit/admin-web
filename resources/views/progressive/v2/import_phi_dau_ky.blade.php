...
@section('content')
    ...
    <section class="content-header">
        <h1>
            Import Excel Phí Dịch Vụ
        </h1>
        <ol class="breadcrumb">
            <li><a href="{{ route('admin.home') }}"><i class="fa fa-home"></i> Trang chủ</a></li>
            <li class="active">Import Excel Phí Dịch Vụ</li>
        </ol>
    </section>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group col-md-4">
                            {!! Form::open(['route' => ['admin.v2.progressive.importexcelphidaukypost'], 'method'=> 'POST','files' => true]) !!}
                                {{ csrf_field() }}
                                ...
                                <div class="form-group">
                                    ...
                                    <a class="btn btn-sm btn-success" title="File mẫu" href="https://bdcadmin.s-tech.info/downloads/phi_dau_ky_template.xlsx"><i class="fa fa-download"></i> File mẫu</a>
                                </div>
                                {!! Form::close() !!}
                        </div>
                    </div>
