...
<section class="content">
    {!! Form::open(['url' =>[route('admin.v2.progressive.store') ] , 'method'=> 'POST','files' => true]) !!}
        <div class="row">
            <div class="col-md-12">
                                ...
                                <div class="card-body progress_price_list">
                                    <div class="form-row temp_one_progress_price_items">
                                        <div class="form-group col-md-6">
                                            {!! Form::text('price', null, ['class' => 'form-control', 'placeholder' => 'Giá tiền']) !!}
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<div class="progress_price_utilities" style="display: none">
    <div class="form-row temp_utiltties_progress_price_items">
        <div class="form-group col-md-4">
            {!! Form::text('option', null, ['class' => 'form-control', 'placeholder' => 'Tiêu đề']) !!}
        </div>
        <div class="form-group col-md-4">
            {!! Form::text('price', null, ['class' => 'form-control', 'placeholder' => 'Giá tiền']) !!}
        </div>
        <div class="form-group col-md-4">
            {!! Form::text('range_time', null, ['class' => 'form-control', 'placeholder' => 'Giá tiền']) !!}
        </div>
    </div>
</div>
<div class="progress_price_multi" style="display: none">
    <div class="form-row progress_price_items">
        ...
        <div class="form-group col-md-3">
            {!! Form::text('progressive[price][0]', old('price'), ['class' => 'form-control', 'placeholder' => 'Giá tiền']) !!}
        </div>
        <div class="form-group col-md-3">
