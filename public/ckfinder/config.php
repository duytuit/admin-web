...
$config['authentication'] = function () {
    return isset($_COOKIE['session_user_id']) ? true : false;
};

/*============================ License Key ============================================*/
// https://ckeditor.com/docs/ckfinder/ckfinder3-php/configuration.html#configuration_options_licenseKey

$config['licenseName'] = 'bdcadmin.dxmb.vn';
$config['licenseKey']  = '6W2W3TXF92H7AAX2SNPPZ7M6EK7M9';
...
//$userDirectory = session('session_user_id');

$userDirectory = '777';
$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      => ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] == "on") ? "https" : "http"). "://". @$_SERVER['HTTP_HOST'].'/ckfinder/userfiles/'.@$_COOKIE['session_user_id'],
    //'root'         => __DIR__ .'/ckfinder/userfiles/'.@$_COOKIE['session_user_id'], // Can be used to explicitly set the CKFinder user files directory.
    //  getBaseUrlByInstance($_GET['id']),
